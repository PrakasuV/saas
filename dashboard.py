...
st.markdown("""
This dashboard provides insights into customer sentiments for Amazon products based on review analysis.
""")
...
# Create tabs
tab1, tab2, tab3, tab4, tab5 = st.tabs(["Overview", "Product Analysis", "Review Explorer", "Live Feed", "Raw Data"])
...
with tab2:
    ...
    with col1:
        ...
        if 'category' in df_sentiment.columns:
            ...
            min_reviews = st.slider("Minimum number of reviews:", 1, max_review_value, 2)        # Apply filters
...
with tab3:
    ...
    # Product selection
    products = ["All Products"] + sorted(df_sentiment['product_name'].unique().tolist())
...
# Footer
st.markdown("---")
st.caption("Amazon Product Reviews Sentiment Analysis Dashboard | Created for Brand Tracking")
